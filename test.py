...
c.drawCentredString(width/2, 22*height/24, "Your presentation")

c.setFont("Helvetica", 20)

c.drawCentredString(width/2, 10*height/24, f"Space usage")

c.setFont("Helvetica", 10)

c.drawCentredString(width/2, 9*height/24, f"Space utilised: {spaceUtilized}")

c.setFont("Helvetica", 20)

c.drawCentredString(width/2, 8*height/24,"Your gestures")

graphWidth = 600
graphHeight = 400

c.drawImage("plot.png", width/2-graphWidth/2, 6*height/24-graphHeight/2, anchor='c', width=graphWidth, height=graphHeight)

c.setFont("Helvetica", 10)

c.drawCentredString(width/2, 4*height/24,"You gestured for too long from:")

c.drawCentredString(width/2, 3*height/24,f"{left_hand_gestures_over_limit}")

c.drawCentredString(width/2, 2*height/24,f"{right_hand_gestures_over_limit}")
